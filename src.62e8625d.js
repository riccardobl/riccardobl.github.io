...
// ASSET: configuration-component.ts
var $U0Fs$export$ConfigurationComponent = function () {
  ...
  ConfigurationComponent.prototype.makeConfigScript = function (attrs) {
    return "<pre><span class=\"pl-s1\">&lt;<span class=\"pl-ent\">script</span> <span class=\"pl-e\">src</span>=<span class=\"pl-s\"><span class=\"pl-pds\">\"</span>https://rblb.it/client.js<span class=\"pl-pds\">\"</span></span></span>\n" + attrs + "\n<span class=\"pl-s1\">        <span class=\"pl-e\">async</span>&gt;</span>\n<span class=\"pl-s1\">&lt;/<span class=\"pl-ent\">script</span>&gt;</span></pre>";
  };
...
document.querySelector('h2#configuration').insertAdjacentElement('afterend', new $U0Fs$export$ConfigurationComponent().element);
return {
  "7QCb": {}
};
});